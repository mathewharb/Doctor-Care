    ...
    <body class="fixed-left">
        ...
        <div class="wrapper-page">
            <div class="card">
                <div class="card-block">
                    <h3 class="text-center m-0">
                       <img src="<?php echo base_url(); ?>assets/images/<?php echo $data[0]['logo']; ?>" height="30" alt="logo">
                    </h3>
                        ...
                        <form class="form-horizontal m-t-30">
                            ...
                            <div class="form-group row m-t-20">
                                <div class="col-12 text-right">
                                    <button class="btn btn-primary btn-block w-md waves-effect waves-light disabled" type="submit" id="reset">Reset</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="m-t-40 text-center">
                <p class="text-white">Remember It ? <a href="<?php echo base_url(); ?>" class="badge badge-info"> Sign In Here </a> </p>
                <p class="text-white">© <?php $data = $this->user_mo->get_user(); echo date('Y').' '.$data[0]['title']; ?>. By: Mathew Harb</p>
            </div>
        </div>
