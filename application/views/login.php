...
<html>
    <head>
        ...
        <title><?php echo $data[0]['title']; ?> - Management System</title>
    ...
    <body class="fixed-left">
        ...
        <div class="wrapper-page">
            <div class="card"  style="box-shadow: 0 0 15px #3c33339c;">
                        ...
                        <form class="form-horizontal m-t-30" method="post" action="<?php echo base_url('user_operation/login'); ?>">
                            ...
                            <div class="form-group m-t-10 mb-0 row">
                                <div class="col-12 m-t-20">
                                    <a href="<?php echo base_url('user/recoverpassword'); ?>" class="btn btn-info btn-block w-md waves-effect waves-light"><i class="mdi mdi-lock"></i> Forgot your password?</a>
                                </div>
                            </div>
                        </form>
                    </div>
