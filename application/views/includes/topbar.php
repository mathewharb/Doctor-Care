        ...
        <header id="topnav">
                        ...
                        <ul class="list-inline float-right mb-0">
                            ...
                            <li class="list-inline-item dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                    <a class="dropdown-item" href="<?php echo base_url('user/profile');?>"><i class="dripicons-user text-muted"></i>Settings</a>
            ...
            <!-- MENU Start -->
            <div class="navbar-custom" style="background-color:#04268c;">
                <div class="container">
                    <div id="navigation">
                        <!-- Navigation Menu-->
