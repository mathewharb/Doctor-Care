...
class User_operation extends CI_Controller {
    ...
    public function recoverpassword()
    {
        ...
        if(count($user) == 1)
        {
            $htmlContent = '<h1>Harb sent your password to login to System</h1>';
            ...
            $this->email->from('harbmathew@yahoo.com');
            $this->email->to($email);
            $this->email->subject('Harb- DoctorCare');
